...
public class RemoveFirstCommand extends Command{
    public RemoveFirstCommand(CollectionManager collectionManager, Data data, Connection connection) {
    ...
    public String execute() {
        try {
            ...
            if (collection.isEmpty()) {
                ...
                return Main.ANSI_YELLOW + "Первый элемент коллекции был удалён!\n" + Main.ANSI_RESET;
            }
